...
////////////////////////////////    Workout Actions     /////////////////////////////////////////////////////////
        ...
        public IActionResult DispMuscle(int muscle_Id)
        {
            ...
            ViewBag.Muscle = DispMuscle;

            User userInDb = dbContext.Users.Include(x=>x.MyPlan).ThenInclude(n=>n.WorkoutPlan).FirstOrDefault( u => u.Email == HttpContext.Session.GetString("UserEmail"));

            ViewBag.LogUser = userInDb;

            var planstuff = dbContext.Users.Include(a=>a.MyPlan).ThenInclude(b=>b.WorkoutPlan).FirstOrDefault(c=>c.UserId == userInDb.UserId);

            ViewBag.UserWorkout = planstuff;


            return View("DispMuscle", planstuff);
        }
        ...
        public IActionResult MyPlan(int userId)
        {
            ...
            if(ViewBag.Compare.UserId!=userId)
            {
                return RedirectToAction("Dashboard");
            }
            else
